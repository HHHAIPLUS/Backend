...
def evaluate_predictions(
    ...
    # A zero trade_return means the prediction did not open a simulated
    # directional position (flat prediction or confidence below the trade
    # threshold). Only actual simulated trades belong in the return average.
    trade_returns = [
        float(result)
