...
FEATURES = [
    ...
    "trend_strength", "trend_strength_72", "trend_alignment", "momentum", "momentum_acceleration",
    "range_position_24", "range_position_72", "volatility_ratio_24_72", "candle_pressure", "volume_price_pressure",
