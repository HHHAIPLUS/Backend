...
FEATURES = [
    ...
    "trend_alignment", "momentum", "momentum_acceleration", "range_position_24", "range_position_72",
    "volatility_ratio_24_72", "candle_pressure", "volume_price_pressure", "body_pct", "upper_wick_pct",
    "lower_wick_pct", "hour_sin", "hour_cos", "day_sin", "day_cos",
]
