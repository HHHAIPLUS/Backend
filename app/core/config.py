...
class Settings(BaseSettings):
    ...
    bitget_api_key:str=''; bitget_api_secret:str=''; bitget_passphrase:str=''; bitget_testnet:bool=False
    ...
    hhhai_execution_exchange:str='bitget'; hhhai_market_exchange:str='bitget'; hhhai_trading_interval_seconds:int=30
